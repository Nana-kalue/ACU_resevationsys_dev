  ...
  try {
    ...
    const dataQuery = `
      SELECT
        ...
        c.furigana as customer_furigana,
        ...
        q.symptoms as questionnaire_symptoms,
        q.medical_history as questionnaire_medical_history,
        q.current_medication as questionnaire_current_medication,
        q.allergies as questionnaire_allergies,
        q.pregnancy as questionnaire_pregnancy,
        q.other_notes as questionnaire_other_notes
      FROM reservations r
      JOIN customers c ON r.customer_id = c.id
      JOIN plans p ON r.plan_id = p.id
      LEFT JOIN questionnaires q ON r.id = q.reservation_id
      ${whereClause}

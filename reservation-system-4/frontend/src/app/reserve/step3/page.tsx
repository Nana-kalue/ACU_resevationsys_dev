      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex justify-center items-center mb-12 overflow-x-auto">
          <div className="flex items-center min-w-max">
            ...
            <div className="w-10 h-10 bg-gray-700 text-white rounded-full flex items-center justify-center font-bold text-sm">3</div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-xl font-bold ml-4 text-gray-900">事前問診</h2>
          </div>
          ...
          <div className="mb-8 space-y-6">
            <div>
              ...
              <textarea
                ...
                rows={4}
                className={`w-full px-4 py-3 border rounded-md text-gray-900 ${errors.symptoms ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
            ...
            <div>
              ...
              <div className="flex gap-6">
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <span className="text-gray-900">妊娠していない</span>
                </label>
                <label className="flex items-center cursor-pointer">
                  <input
                    type="radio"
                    ...
                    className="mr-2 w-4 h-4 text-blue-600"
                  />
                  <span className="text-gray-900">妊娠中</span>
                </label>
                <label className="flex items-center cursor-pointer">
                  <input
                    type="radio"
                    ...
                    className="mr-2 w-4 h-4 text-blue-600"
                  />
                  <span className="text-gray-900">妊娠の可能性がある</span>
                </label>
              </div>
            </div>

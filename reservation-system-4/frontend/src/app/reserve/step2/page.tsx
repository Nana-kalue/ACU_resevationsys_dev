      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex justify-center items-center mb-12 overflow-x-auto">
          <div className="flex items-center min-w-max">
            ...
            <div className="w-10 h-10 bg-gray-700 text-white rounded-full flex items-center justify-center font-bold text-sm">2</div>
            ...
            <div className="text-center ml-1 mr-4"><div className="text-xs font-medium text-gray-700">事前問診</div></div>
            <div className="w-12 h-0.5 bg-gray-300 mx-2"></div>

            <div className="w-10 h-10 bg-gray-400 text-white rounded-full flex items-center justify-center font-bold text-sm">4</div>
            <div className="text-center ml-1"><div className="text-xs font-medium text-gray-700">内容確認</div></div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-xl font-bold ml-4 text-gray-900">基本情報の入力</h2>
          </div>

          {selectedPlan && selectedDate && selectedTime && (
            <div className="mb-8 p-4 bg-blue-50 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-2">選択された内容</h3>
              <p className="text-sm text-gray-800">プラン: {selectedPlan.display_name}</p>
              <p className="text-sm text-gray-800">日時: {getSelectedDateTime()}</p>
            </div>
          )}

          <div className="mb-8">
            <h3 className="text-base font-semibold mb-4 text-gray-900">基本情報</h3>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-md text-gray-900 ${errors.name ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                placeholder="山田太郎"
              />
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-md text-gray-900 ${errors.furigana ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                placeholder="ヤマダタロウ"
              />
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-6">
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <span className="text-gray-900">男性</span>
                </label>
                <label className="flex items-center cursor-pointer">
                  <input
                    type="radio"
                    ...
                    className="mr-2 w-4 h-4 text-blue-600"
                  />
                  <span className="text-gray-900">女性</span>
                </label>
                <label className="flex items-center cursor-pointer">
                  <input
                    type="radio"
            ...
            <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-md text-gray-900 ${errors.birthdate ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-md text-gray-900 ${errors.phone ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
            ...
            <div className="mb-6">
              ...
              />
              <p className="mt-1 text-xs text-gray-600">※ 予約確認メールを受け取る場合は入力してください</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-md text-gray-900 ${errors.address ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                placeholder="東京都渋谷区（市区町村まででも可）"
              />
              {errors.address && <p className="mt-1 text-sm text-red-600">{errors.address}</p>}
              <p className="mt-1 text-xs text-gray-600">※ 市区町村まででも構いません</p>
            </div>
          </div>

          {/* 同意書セクション */}
          <div className="mb-8 border-t pt-8">
            <h3 className="text-lg font-bold mb-4 text-gray-900">ご予約にあたっての同意事項</h3>
            ...
            <div className="border border-gray-300 rounded-lg mb-4">
              ...
              >
                <span className="font-semibold text-left text-gray-900">施術に関する同意事項</span>
                {expandedSections.treatment ? <ChevronUp className="w-5 h-5 text-gray-900" /> : <ChevronDown className="w-5 h-5 text-gray-900" />}
              </button>
              {expandedSections.treatment && (
                <div className="px-4 py-4 text-sm text-gray-800 space-y-2 border-t">
            ...
            <div className="border border-gray-300 rounded-lg mb-4">
              <button
                ...
                className="w-full px-4 py-3 flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors rounded-t-lg"
              >
                <span className="font-semibold text-left text-gray-900">キャンセルポリシー</span>
                {expandedSections.cancellation ? <ChevronUp className="w-5 h-5 text-gray-900" /> : <ChevronDown className="w-5 h-5 text-gray-900" />}
              </button>
            ...
            <div className="border border-gray-300 rounded-lg mb-6">
              <button
                ...
                className="w-full px-4 py-3 flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors rounded-t-lg"
              >
                <span className="font-semibold text-left text-gray-900">免責事項</span>
                {expandedSections.disclaimer ? <ChevronUp className="w-5 h-5 text-gray-900" /> : <ChevronDown className="w-5 h-5 text-gray-900" />}
              </button>

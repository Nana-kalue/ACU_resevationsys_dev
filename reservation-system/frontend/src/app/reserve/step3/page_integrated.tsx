    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold mb-2">予約を作成中...</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="space-y-6 mb-8">
            <div>
              ...
              {selectedPlan?.price && (
                <p className="text-sm text-gray-600">料金: ¥{selectedPlan.price.toLocaleString()}</p>
              )}
          ...
          <div className="flex justify-between">
            <div className="flex gap-3">
              ...
              <button onClick={handleRestart} className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors">
                最初からやり直す
              </button>
            </div>
            <button
